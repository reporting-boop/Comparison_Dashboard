            ...
            <div
              ...
              style={{
                ...
                color: selected.includes(opt)
                  ? PURPLE
                  : "#374151",
                fontWeight: selected.includes(opt)
                  ? 600
                  : 400
              }}
            >
...
function calcStats(rows) {
  ...
  return {
    ...
    apoCurr: avg(r => r.apo_curr),
    apoPrev: avg(r => r.apo_prev),
    apoTrend: avg(r => r.apo_pct),
    ...
    <div>
      ...
      <div style={{ padding: "20px 28px" }}>
        ...
        >
          ...
          <StatCard
            label="Total Voice"
            curr={stats.voiceCurr}
            prev={stats.voicePrev}
            trend={stats.voiceTrend}
            format={fmtNum}
            accent="amber"
          />
          ...
          <StatCard
            ...
            curr={stats.upgradesCurr}
            prev={stats.upgradesPrev}
            trend={stats.upgradesTrend}
            format={fmtNum}
            accent="blue"
          />
